  ...
  const setupPushNotifications =
    async () => {
      try {
        ...
        // ----------------------------------------------------
        // 2. Register current FCM token
        // ----------------------------------------------------

        console.log(
          "CUSTOMER FCM: REGISTERING TOKEN FOR",
          user.uid,
        );
        ...
        if (token) {
          console.log(
            "CUSTOMER FCM TOKEN REGISTERED",
          );
        } else {
          console.log(
            "CUSTOMER FCM TOKEN REGISTRATION FAILED",
          );
        }
        ...
        console.log(
          "CUSTOMER FOREGROUND PUSH LISTENER READY",
        );
      } catch (error) {
        console.error(
          "CUSTOMER PUSH SETUP ERROR:",
          error,
        );
      }
    };
      ...
      >
        ...
        {activeBooking ? (
          ...
          >
            ...
            <View
              style={
                styles.activeBookingDetails
              }
            >

              <View
                style={
                  styles.activeBookingDetail
                }
              >
                <Text
                  style={
            ...
            <Pressable
              style={
                styles.activeBookingAction
              }
              onPress={
                handleActiveBookingStatus
              }
            >
              <Text
                style={
          ...
          >
            ...
            <View
              style={
                styles.emptyBookingContent
              }
            >

              <Text
                style={
                  styles.emptyBookingTitle
                }
              >
                No active booking
              </Text>
        ...
        >
          ...
          >
            ...
            >
              HouseHelp connects you
              with verified helpers
        ...
        {/* Extra content space so bottom nav
            never covers the last card */}

        <View
          style={
            styles.bottomContentSpace
          }
        />
...
const styles =
  StyleSheet.create({
    ...
    content: {
      ...
      // Safe spacing below status bar/header
      paddingTop: 18,
